  ...
  setup %{conn: conn} do
    ...
    respondent = insert(:respondent, phone_number: "123", state: "active")
    {
      ...
      twiml_map: [
        ...
        {Flow.Message.answer, {:reply, ReplyHelper.simple("Step", Ask.StepBuilder.audio_prompt(uuid: "foo", text: "Do you exercise?"))}, "<Play>http://app.ask.dev/audio/foo.mp3</Play>"},
        {Flow.Message.reply("8"), {:reply, ReplyHelper.simple("Step", Ask.StepBuilder.audio_prompt(uuid: "foo", text: "Do you exercise?"))}, "<Play>http://app.ask.dev/audio/foo.mp3</Play>"},
      ]
    }
  end
