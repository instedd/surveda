defmodule Ask.Runtime.ChannelPatternsTest do
  use ExUnit.Case
  ...
  test "matches sanitized phone number against input patterns" do
    ...
    patterns = [
      # matches
      %{"input" => "1XXX", "output" => "1XXX"},
      # matches
      %{"input" => "X2XX", "output" => "1XXX"},
      # matches
      %{"input" => "XX3X", "output" => "1XXX"},
      # matches
      %{"input" => "XXX4", "output" => "1XXX"},
      # matches
      %{"input" => "12XX", "output" => "1XXX"},
      # matches
      %{"input" => "XX34", "output" => "1XXX"},
      # matches
      %{"input" => "1XX4", "output" => "1XXX"},
      # doesn't match
      %{"input" => "5XXX", "output" => "1XXX"},
      # doesn't match
      %{"input" => "X5XX", "output" => "1XXX"},
      # doesn't match
      %{"input" => "XX5X", "output" => "1XXX"},
      # doesn't match
      %{"input" => "XXX5", "output" => "1XXX"},
      # doesn't match
      %{"input" => "XXXXX", "output" => "1XXX"},
      # doesn't match
      %{"input" => "1234X", "output" => "1XXX"},
      # doesn't match
      %{"input" => "X1234", "output" => "1XXX"}
    ]
  ...
  test "applies output pattern to sanitized phone number" do
    ...
    assert patterns |> Enum.map(&ChannelPatterns.apply_pattern(&1, canonical_phone_number)) ==
             expected_canonical_phone_numbers
  end
end
