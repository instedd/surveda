defmodule Ask.RetryStatTest do
  ...
  test "inserts stat" do
    ...
    filter = %{attempt: 1, mode: "sms", retry_time: "2019101615", survey: survey}
  ...
  test "increases specific stat" do
    ...
    filter1 = %{attempt: 1, mode: "sms", retry_time: "2019101615", survey: survey}
    filter2 = %{attempt: 2, mode: "sms", retry_time: "2019101615", survey: survey}
    filter3 = %{attempt: 3, mode: "sms", retry_time: "2019101615", survey: survey}
    filter4 = %{attempt: 1, mode: "ivr", retry_time: "2019101615", survey: survey}
    filter5 = %{attempt: 1, mode: "ivr", retry_time: "2019101616", survey: survey}
    filter6 = %{attempt: 1, mode: "ivr", retry_time: "2019101616", survey: survey1}
