  ...
  describe "show" do
    ...
    test "shows chosen resource", %{conn: conn, user: user} do
      ...
      assert json_response(conn, 200)["data"] == %{"id" => survey.id,
        ...
        "first_window_started_at" => Timex.format!(survey.started_at, "%FT%T%:z", :strftime)
      }
    end
