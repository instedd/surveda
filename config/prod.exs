...
#
#     config :ask, AskWeb.Endpoint, root: "."

config :ask, AskWeb.Endpoint, secret_key_base: System.get_env("SECRET_KEY_BASE")
...
config :coherence, AskWeb.Coherence.Mailer, smtp_config
