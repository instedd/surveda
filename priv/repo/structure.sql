...
--
-- Table structure for table `channel_broker_info`
--

DROP TABLE IF EXISTS `channel_broker_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `channel_broker_info` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `channel_id` bigint(20) unsigned DEFAULT NULL,
  `contact_timestamps` json DEFAULT NULL,
  `contacts_queue_ids` json DEFAULT NULL,
  `inserted_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `channel_broker_info_channel_id_fkey` (`channel_id`),
  CONSTRAINT `channel_broker_info_channel_id_fkey` FOREIGN KEY (`channel_id`) REFERENCES `channels` (`id`)
...
-- Dump completed on 2022-08-04  8:56:27
