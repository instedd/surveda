defmodule Ask.Runtime.ChannelBroker do
  ...
  def message_expired?(nil, channel_type, channel, channel_state) do
    message_expired?(0, channel_type, channel, channel_state)
  end

  def message_expired?(channel_id, channel_type, channel, channel_state) do
    call_gen_server(channel_id, {:message_expired?, channel_type, channel, channel_state})
  end
