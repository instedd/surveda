...
const Header = ({
  ...
  if (project && showQuestionnairesLink) {
    questionnairesLink = (
      <li className="breadcrumb-item">
        <Link to={routes.questionnaireIndex(project.id)} className="">
          {t("Questionnaires")}
        </Link>
      </li>
    )
  ...
  const folderLink = folder ? (
    <li className="breadcrumb-item">
      <Link to={routes.folder(folder.projectId, folder.id)} className="">
        {folder.name}
      </Link>
    </li>
  ) : null
  ...
  const panelSurveyLink = panelSurvey ? (
    <li className="breadcrumb-item">
      <Link to={routes.panelSurvey(panelSurvey.projectId, panelSurvey.id)} className="">
        {panelSurvey.name || t("Untitled panel survey")}
      </Link>
    </li>
  ) : null
          ...
          <div className="row">
            <div className="col s12">
              <ul className="breadcrumb-top">
                <li>
                  <Link to={routes.projects} className="">
                    {t("Projects")}
                  </Link>
                </li>
                {projectLink}
              ...
              <ul className="right user-menu">
                <li>
                  ...
                  >
                    ...
                    <DropdownItem>
                      <a href="/?explicit=true" target="_blank">
                        {t("About Surveda")}
                      </a>
                    </DropdownItem>
                    <DropdownItem>
