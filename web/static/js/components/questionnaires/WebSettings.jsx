...
class WebSettings extends Component {
      ...
      <div className="row" ref="self">
        <Card className="z-depth-0">
          <ul className="collection collection-card dark">
            ...
            <li className="collection-item">{this.colorSelectionComponent()}</li>
            <li className="collection-item">
              <h5>{t("Messages")}</h5>
              {this.errorMessageComponent()}
            </li>
            <li className="collection-item">{this.thankYouMessageComponent()}</li>
            <li className="collection-item">{this.titleComponent()}</li>
            <li className="collection-item">{this.introMessageComponent()}</li>
            <li className="collection-item">{this.smsMessageComponent()}</li>
            <li className="collection-item">{this.surveyIsOverMessageComponent()}</li>
            <li className="collection-item">{this.surveyAlreadyTakenMessageComponent()}</li>
          </ul>
        </Card>
      </div>
    )
  ...
  surveyIsOverMessageComponent() {
    return (
      <MobileWebPrompt
        id="web_settings_survey_is_over"
  ...
  surveyAlreadyTakenMessageComponent() {
    return (
      <MobileWebPrompt
        id="web_settings_survey_already_taken"
  ...
  colorSelectionComponent() {
    ...
    const primary =
      hasPrimaryErrors || !this.state.primaryColor ? "#6648a2" : this.state.primaryColor
    const secondary =
      hasSecondaryErrors || !this.state.secondaryColor ? "#fb9a00" : this.state.secondaryColor
    ...
    return (
      <div className="style row">
        ...
        <div className="col s12 m6 l4 web-color input-field">
          ...
          <InputWithLabel
            id="web_settings_secondary_color"
...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    errorMessage: getPromptMobileWeb(
      questionnaire.settings.errorMessage,
      questionnaire.activeLanguage
    ),
    thankYouMessage: getPromptMobileWeb(
      questionnaire.settings.thankYouMessage,
      questionnaire.activeLanguage
    ),
    ...
    surveyAlreadyTakenMessage:
      (questionnaire.settings.surveyAlreadyTakenMessage || {})[questionnaire.activeLanguage] || "",
    primaryColor:
      (questionnaire.settings.mobileWebColorStyle &&
        questionnaire.settings.mobileWebColorStyle.primaryColor) ||
      "",
    secondaryColor:
      (questionnaire.settings.mobileWebColorStyle &&
        questionnaire.settings.mobileWebColorStyle.secondaryColor) ||
      "",
  }
}
