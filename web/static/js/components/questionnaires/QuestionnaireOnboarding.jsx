      ...
      <div className='col s12 m5 offset-m2'>
        <div className='carousel carousel-slider center' data-indicators='true'>
          <div className='carousel-fixed-item center'>
            <a className='btn btn-flat-link' onClick={() => onDismiss()}>{t('Understood, create the first step')}</a>
          </div>
          <div className='carousel-item grey-text' href='#one!'>
            ...
            <p>{t('When you add more than one language a step for language selection will be enabled and you\'ll be able to define every step in each of the selected languages.')}</p>
          </div>
          <div className='carousel-item grey-text' href='#two!'>
            ...
            <p>{t('When more than one mode is enabled you\'ll be able to set up messages and interactions at every step for each selected mode.')}</p>
          </div>
          <div className='carousel-item grey-text' href='#three!'>
            ...
            <p>{t('Questionnaires are organized in steps. Each step type offers different features like multiple choice, numeric input or just an explanation . The comparison steps allow A/B testing.')}</p>
          </div>
        </div>
      </div>
    )
