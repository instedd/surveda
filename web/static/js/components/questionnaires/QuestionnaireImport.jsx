      ...
      <div className="center-align">
        <svg width={sqSize} height={sqSize} viewBox={viewBox}>
          <path
            ...
            d="M75,0c41.4,0,75,33.6,75,75s-33.6,75-75,75S0,116.4,0,75S33.6,0,75,0L75,0z M48.4,106.9h52.4v-7.6H48.4V106.9z M85.8,91.8V69.3h14.9L74.6,43.1L48.4,69.3h14.9v22.5L85.8,91.8L85.8,91.8z"
          />
          <circle
        ...
        <h5 className="grey-text lighten-1">{t("Uploading questionnaire")}</h5>
        <br />
