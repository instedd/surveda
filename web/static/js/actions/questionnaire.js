...
export const SET_MOBILE_WEB_SETTING_TEXT = 'QUESTIONNAIRE_SET_MOBILE_WEB_SETTING_TEXT'
...
export const setMobileWebSettingText = (key, text) => ({
  type: SET_MOBILE_WEB_SETTING_TEXT,
  key,
  text
})
