...
export const SURVEY_SET_INITIAL_CUTOFF_CONFIG = 'SURVEY_SET_INITIAL_CUTOFF_CONFIG'
...
export const surveySetInitialCutOffConfig = (survey) => ({
  type: SURVEY_SET_INITIAL_CUTOFF_CONFIG,
  survey
})
