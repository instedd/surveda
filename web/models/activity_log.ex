defmodule Ask.ActivityLog do
  ...
  def valid_actions("survey"), do:
    ["create", "edit", "rename", "change_description", "lock", "unlock", "delete", "start", "request_cancel", "confirm_cancel", "download", "enable_public_link", "regenerate_public_link", "disable_public_link", "change_folder"]
  ...
  def confirm_cancel(project, conn, survey) do
    create("confirm_cancel", project, conn, survey, %{survey_name: survey.name})
  end
