  ...
  getModeAttemptsValues() {
    ...
    let modeValueRow = surveyModes
      ...
      .map(function (element, index) {
        ...
        return (
          <td className="tdNumber" key={index}>
            {modeValue}
          </td>
        )
      })
  ...
  render() {
    ...
    return (
      <tr key={respondent.id}>
        ...
        {this.isFieldSelected("fixed", "disposition") ? (
          <td>{capitalize(respondent.disposition)}</td>
        ) : null}
        ...
        this.isFieldSelected("partial_relevant", "answered_questions") ? (
          <td className="tdNumber">{respondent.partialRelevant.answeredCount}</td>
        ) : null}
        {responses
