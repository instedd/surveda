...
class FlagStepEditor extends Component<Props, State> {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <StepCard
        ...
        icon={<StepTypeSelector stepType={step.type} stepId={step.id} readOnly={readOnly} />}
      >
        <li className="collection-item" key="dispositions">
          <h5>{t("Disposition")}</h5>
          <p>
            <b>{t("Choose the disposition you want to set at this point of the questionnaire.")}</b>
          </p>
          <div className="row">
