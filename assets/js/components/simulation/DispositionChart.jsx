...
class DispositionChart extends Component<Props> {
  ...
  render() {
    ...
    return (
      <div className="quex-simulation-disposition">
        <h4>{t("Disposition")}</h4>
                ...
                <ul>
                  ...
                  >
                    ...
                    <ul>
                      <li
                        className={classNames({
                          active: disposition == "unresponsive",
                        })}
                      >
                        <input
                          id="unresponsive"
            ...
            <div className="row">
              ...
              <div className="col s9">
                <ul className="last">
                  ...
                  <li
                    className={classNames({
                      active: disposition == "interim partial",
                    })}
                  >
                    <input
                      id="interim partial"
