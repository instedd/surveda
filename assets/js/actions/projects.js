...
export const fetchProjects =
  ...
  (dispatch: Function, getState: () => Store) => {
    ...
    return api
      ...
      .then((response) =>
        dispatch(receiveProjects(response.entities.projects || {}, optionsOrDefault["archived"]))
      )
  }
...
export const archiveOrUnarchive =
  (project: Project, action: string) => (dispatch: Function, getState: () => Store) => {
