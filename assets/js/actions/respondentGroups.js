...
export const CLEAR_INVALID_RESPONDENTS_FOR_GROUP =
  "RESPONDENT_GROUP_CLEAR_INVALID_RESPONDENTS_FOR_GROUP"
...
export const fetchRespondentGroups = (projectId, surveyId) => (dispatch) => {
  ...
  api.fetchRespondentGroups(projectId, surveyId).then((response) => {
...
export const removeRespondentGroup = (projectId, surveyId, groupId) => (dispatch, getState) => {
  api.removeRespondentGroup(projectId, surveyId, groupId).then(() => dispatch(surveyActions.save()))
...
export const selectChannels = (projectId, surveyId, groupId, channels) => (dispatch, getState) => {
  api
    .updateRespondentGroup(projectId, surveyId, groupId, { channels })
