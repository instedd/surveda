...
export const changeFolder =
  (panelSurvey: PanelSurvey, folderId: number) => (dispatch: Function, getState: () => Store) => {
    return api
      .panelSurveySetFolderId(panelSurvey.projectId, panelSurvey.id, folderId)
...
export const deletePanelSurvey = (panelSurvey: PanelSurvey) => (dispatch: Function) => {
  api
    .deletePanelSurvey(panelSurvey.projectId, panelSurvey)
